  ...
  <b-container class="bv-example-row mt-3" >
    ...
    <b-form @submit.prevent="signup">
      <b-form-group class="mt-3 mb-3">
        <b-form-input type="text" v-model="userid" placeholder="아이디를 입력하세요"></b-form-input>
      </b-form-group>
      <b-form-group class="mt-3 mb-3">
        <b-form-input type="text" v-model="username" placeholder="이름을 입력하세요"></b-form-input>
      </b-form-group>
      <b-form-group class="mt-3 mb-3">
        <b-form-input type="password" v-model="userpwd" placeholder="비밀번호를 입력하세요"></b-form-input>
      </b-form-group>
      <b-form-group class="mt-3 mb-3">
        <b-form-input type="text" v-model="email" placeholder="이메일을 입력하세요"></b-form-input>
      </b-form-group>
      <b-form-group class="mt-3 mb-3">
        <b-form-input type="text" v-model="address" placeholder="주소를 입력하세요"></b-form-input>
      </b-form-group>
